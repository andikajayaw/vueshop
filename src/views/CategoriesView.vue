<template>
  <div>
    <v-container class="ma-0 pa-0" grid-list-sm>
        ...
        <v-layout wrap>
            <v-flex v-for="(category) in categories" :key="`category-${category.id}`" xs-6>
        ...
        <v-pagination v-model="page" @input="getListCategories()" :length="lengthPage" :total-visible="5"></v-pagination>
    </v-container>
  </div>
</template>
